...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 67 5a 10 80 	movl   $0x80105a67,0x14(%eax)
  p->context = (struct context*)sp;
...
80103b38:	0f 84 be 00 00 00    	je     80103bfc <fork+0xec>
...
80103b55:	0f 84 a8 00 00 00    	je     80103c03 <fork+0xf3>
  np->sz = curproc->sz;
...
80103bc1:	e8 fa 0d 00 00       	call   801049c0 <safestrcpy>
  np->nrswitch = 0;
80103bc6:	c7 47 7c 00 00 00 00 	movl   $0x0,0x7c(%edi)
  pid = np->pid;
80103bcd:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bd0:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103bd7:	e8 64 0b 00 00       	call   80104740 <acquire>
  np->state = RUNNABLE;
80103bdc:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103be3:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103bea:	e8 f1 0a 00 00       	call   801046e0 <release>
  return pid;
80103bef:	83 c4 10             	add    $0x10,%esp
}
80103bf2:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103bf5:	89 d8                	mov    %ebx,%eax
80103bf7:	5b                   	pop    %ebx
80103bf8:	5e                   	pop    %esi
80103bf9:	5f                   	pop    %edi
80103bfa:	5d                   	pop    %ebp
80103bfb:	c3                   	ret    
    return -1;
80103bfc:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103c01:	eb ef                	jmp    80103bf2 <fork+0xe2>
    kfree(np->kstack);
80103c03:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103c06:	83 ec 0c             	sub    $0xc,%esp
    return -1;
80103c09:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    kfree(np->kstack);
80103c0e:	ff 77 08             	push   0x8(%edi)
80103c11:	e8 aa e8 ff ff       	call   801024c0 <kfree>
    np->kstack = 0;
80103c16:	c7 47 08 00 00 00 00 	movl   $0x0,0x8(%edi)
    return -1;
80103c1d:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103c20:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    return -1;
80103c27:	eb c9                	jmp    80103bf2 <fork+0xe2>
...
80103c74:	75 37                	jne    80103cad <scheduler+0x7d>
      switchuvm(p);
...
80103c8a:	57                   	push   %edi
      p->nrswitch++;
80103c8b:	83 43 7c 01          	addl   $0x1,0x7c(%ebx)
      p->state = RUNNING;
80103c8f:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c96:	e8 80 0d 00 00       	call   80104a1b <swtch>
      switchkvm();
80103c9b:	e8 50 2f 00 00       	call   80106bf0 <switchkvm>
      c->proc = 0;
80103ca0:	83 c4 10             	add    $0x10,%esp
80103ca3:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103caa:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cad:	83 eb 80             	sub    $0xffffff80,%ebx
80103cb0:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
80103cb6:	75 b8                	jne    80103c70 <scheduler+0x40>
    release(&ptable.lock);
80103cb8:	83 ec 0c             	sub    $0xc,%esp
80103cbb:	68 20 1d 11 80       	push   $0x80111d20
80103cc0:	e8 1b 0a 00 00       	call   801046e0 <release>
    sti();
80103cc5:	83 c4 10             	add    $0x10,%esp
80103cc8:	eb 86                	jmp    80103c50 <scheduler+0x20>
...
801042ae:	e8 8d 04 00 00       	call   80104740 <acquire>
...
801042ca:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
801042cf:	75 ef                	jne    801042c0 <getNumProc+0x20>
  }
  release(&ptable.lock);
801042d1:	83 ec 0c             	sub    $0xc,%esp
801042d4:	68 20 1d 11 80       	push   $0x80111d20
801042d9:	e8 02 04 00 00       	call   801046e0 <release>
...
801042f3:	53                   	push   %ebx
  struct proc *p;
  int maxPid = -1;
801042f4:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
int getMaxPid(void) {
801042f9:	83 ec 10             	sub    $0x10,%esp

  acquire(&ptable.lock);
801042fc:	68 20 1d 11 80       	push   $0x80111d20
80104301:	e8 3a 04 00 00       	call   80104740 <acquire>
80104306:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104309:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
8010430e:	66 90                	xchg   %ax,%ax
    if(p->state != UNUSED && p->pid > maxPid)
80104310:	8b 50 0c             	mov    0xc(%eax),%edx
80104313:	85 d2                	test   %edx,%edx
80104315:	74 08                	je     8010431f <getMaxPid+0x2f>
80104317:	8b 50 10             	mov    0x10(%eax),%edx
8010431a:	39 d3                	cmp    %edx,%ebx
8010431c:	0f 4c da             	cmovl  %edx,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010431f:	83 e8 80             	sub    $0xffffff80,%eax
80104322:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80104327:	75 e7                	jne    80104310 <getMaxPid+0x20>
      maxPid = p->pid;
  }
  release(&ptable.lock);
80104329:	83 ec 0c             	sub    $0xc,%esp
8010432c:	68 20 1d 11 80       	push   $0x80111d20
80104331:	e8 aa 03 00 00       	call   801046e0 <release>

  return maxPid;
}
80104336:	89 d8                	mov    %ebx,%eax
80104338:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010433b:	c9                   	leave  
8010433c:	c3                   	ret    
8010433d:	8d 76 00             	lea    0x0(%esi),%esi

80104340 <countUniqueOpenFiles>:
...
80104347:	8b 4d 08             	mov    0x8(%ebp),%ecx

    for (int i = 0; i < NOFILE; i++) {
8010434a:	31 f6                	xor    %esi,%esi
int countUniqueOpenFiles(struct file *ofile[NOFILE]) {
8010434c:	53                   	push   %ebx
8010434d:	eb 0c                	jmp    8010435b <countUniqueOpenFiles+0x1b>
8010434f:	90                   	nop
    for (int i = 0; i < NOFILE; i++) {
80104350:	83 c6 01             	add    $0x1,%esi
80104353:	83 c1 04             	add    $0x4,%ecx
80104356:	83 fe 10             	cmp    $0x10,%esi
80104359:	74 34                	je     8010438f <countUniqueOpenFiles+0x4f>
        if (ofile[i] != 0) {
8010435b:	8b 19                	mov    (%ecx),%ebx
8010435d:	85 db                	test   %ebx,%ebx
8010435f:	74 ef                	je     80104350 <countUniqueOpenFiles+0x10>
            int isUnique = 1;
            for (int j = 0; j < i; j++) {
80104361:	85 f6                	test   %esi,%esi
80104363:	74 1c                	je     80104381 <countUniqueOpenFiles+0x41>
80104365:	8b 45 08             	mov    0x8(%ebp),%eax
80104368:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010436f:	90                   	nop
                if (ofile[j] != 0 && ofile[j] == ofile[i]) {
80104370:	8b 10                	mov    (%eax),%edx
80104372:	39 d3                	cmp    %edx,%ebx
80104374:	75 04                	jne    8010437a <countUniqueOpenFiles+0x3a>
80104376:	85 d2                	test   %edx,%edx
80104378:	75 d6                	jne    80104350 <countUniqueOpenFiles+0x10>
            for (int j = 0; j < i; j++) {
8010437a:	83 c0 04             	add    $0x4,%eax
8010437d:	39 c1                	cmp    %eax,%ecx
8010437f:	75 ef                	jne    80104370 <countUniqueOpenFiles+0x30>
    for (int i = 0; i < NOFILE; i++) {
80104381:	83 c6 01             	add    $0x1,%esi
                    isUnique = 0;
                    break;
                }
            }
            if (isUnique) {
                count++;
80104384:	83 c7 01             	add    $0x1,%edi
    for (int i = 0; i < NOFILE; i++) {
80104387:	83 c1 04             	add    $0x4,%ecx
8010438a:	83 fe 10             	cmp    $0x10,%esi
8010438d:	75 cc                	jne    8010435b <countUniqueOpenFiles+0x1b>
            }
        }
    }
...
801043a5:	53                   	push   %ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043a6:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
int getProcInfo(int pid, struct processInfo *pi) {
801043ab:	83 ec 18             	sub    $0x18,%esp
801043ae:	8b 75 08             	mov    0x8(%ebp),%esi
801043b1:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&ptable.lock);
801043b4:	68 20 1d 11 80       	push   $0x80111d20
801043b9:	e8 82 03 00 00       	call   80104740 <acquire>
801043be:	83 c4 10             	add    $0x10,%esp
801043c1:	eb 10                	jmp    801043d3 <getProcInfo+0x33>
801043c3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801043c7:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043c8:	83 eb 80             	sub    $0xffffff80,%ebx
801043cb:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
801043d1:	74 4d                	je     80104420 <getProcInfo+0x80>
    if(p->pid == pid){
801043d3:	39 73 10             	cmp    %esi,0x10(%ebx)
801043d6:	75 f0                	jne    801043c8 <getProcInfo+0x28>
      pi->state = p->state;
801043d8:	8b 43 0c             	mov    0xc(%ebx),%eax
801043db:	89 07                	mov    %eax,(%edi)
      pi->ppid = p->parent ? p->parent->pid : 0;
801043dd:	8b 53 14             	mov    0x14(%ebx),%edx
801043e0:	31 c0                	xor    %eax,%eax
801043e2:	85 d2                	test   %edx,%edx
801043e4:	74 03                	je     801043e9 <getProcInfo+0x49>
801043e6:	8b 42 10             	mov    0x10(%edx),%eax
801043e9:	89 47 04             	mov    %eax,0x4(%edi)
      pi->sz = p->sz;
801043ec:	8b 03                	mov    (%ebx),%eax
      pi->nfd = countUniqueOpenFiles(p->ofile);
801043ee:	83 ec 0c             	sub    $0xc,%esp
      pi->sz = p->sz;
801043f1:	89 47 08             	mov    %eax,0x8(%edi)
      pi->nfd = countUniqueOpenFiles(p->ofile);
801043f4:	8d 43 28             	lea    0x28(%ebx),%eax
801043f7:	50                   	push   %eax
801043f8:	e8 43 ff ff ff       	call   80104340 <countUniqueOpenFiles>
801043fd:	89 47 0c             	mov    %eax,0xc(%edi)
      pi->nrswitch = p->nrswitch;
80104400:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104403:	89 47 10             	mov    %eax,0x10(%edi)
  release(&ptable.lock);
80104406:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010440d:	e8 ce 02 00 00       	call   801046e0 <release>
...
80104428:	e8 b3 02 00 00       	call   801046e0 <release>
    return -1;
...
8010444a:	68 24 7a 10 80       	push   $0x80107a24
...
80104685:	68 2f 7a 10 80       	push   $0x80107a2f
8010468a:	e8 f1 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010468f:	83 ec 0c             	sub    $0xc,%esp
80104692:	68 46 7a 10 80       	push   $0x80107a46
...
801046fb:	68 4d 7a 10 80       	push   $0x80107a4d
...
801047f0:	68 55 7a 10 80       	push   $0x80107a55
...
80104c1c:	8b 14 85 80 7a 10 80 	mov    -0x7fef8580(,%eax,4),%edx
...
80104c48:	68 5d 7a 10 80       	push   $0x80107a5d
...
80104da4:	68 00 7b 10 80       	push   $0x80107b00
...
80104dbc:	68 ff 7a 10 80       	push   $0x80107aff
...
80104dd1:	68 f3 7a 10 80       	push   $0x80107af3
...
80104def:	68 02 7b 10 80       	push   $0x80107b02
80104df4:	e8 87 b5 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104df9:	83 ec 0c             	sub    $0xc,%esp
80104dfc:	68 e4 7a 10 80       	push   $0x80107ae4
...
801051fd:	58                   	pop    %eax
801051fe:	5a                   	pop    %edx
801051ff:	68 00 7b 10 80       	push   $0x80107b00
...
80105218:	68 ff 7a 10 80       	push   $0x80107aff
...
80105a0c:	e8 af f0 ff ff       	call   80104ac0 <argint>
80105a11:	83 c4 10             	add    $0x10,%esp
80105a14:	85 c0                	test   %eax,%eax
80105a16:	78 30                	js     80105a48 <sys_getProcInfo+0x48>
80105a18:	83 ec 04             	sub    $0x4,%esp
80105a1b:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105a1e:	6a 14                	push   $0x14
80105a20:	50                   	push   %eax
80105a21:	6a 01                	push   $0x1
80105a23:	e8 e8 f0 ff ff       	call   80104b10 <argptr>
80105a28:	83 c4 10             	add    $0x10,%esp
80105a2b:	85 c0                	test   %eax,%eax
80105a2d:	78 19                	js     80105a48 <sys_getProcInfo+0x48>
    return -1;

  return getProcInfo(pid, pi);
80105a2f:	83 ec 08             	sub    $0x8,%esp
80105a32:	ff 75 f4             	push   -0xc(%ebp)
80105a35:	ff 75 f0             	push   -0x10(%ebp)
80105a38:	e8 63 e9 ff ff       	call   801043a0 <getProcInfo>
...
80105a50:	06                   	push   %es
  pushl %fs
80105a51:	0f a0                	push   %fs
  pushl %gs
80105a53:	0f a8                	push   %gs
  pushal
80105a55:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105a56:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105a5a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105a5c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105a5e:	54                   	push   %esp
  call trap
80105a5f:	e8 cc 00 00 00       	call   80105b30 <trap>
  addl $4, %esp
80105a64:	83 c4 04             	add    $0x4,%esp
...
80105a67:	61                   	popa   
  popl %gs
80105a68:	0f a9                	pop    %gs
  popl %fs
80105a6a:	0f a1                	pop    %fs
  popl %es
80105a6c:	07                   	pop    %es
  popl %ds
80105a6d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105a6e:	83 c4 08             	add    $0x8,%esp
  iret
80105a71:	cf                   	iret   
80105a72:	66 90                	xchg   %ax,%ax
80105a74:	66 90                	xchg   %ax,%ax
...
80105a97:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
80105a9e:	08 00 00 8e 
80105aa2:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105aa9:	80 
80105aaa:	c1 ea 10             	shr    $0x10,%edx
80105aad:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105ab4:	80 
  for(i = 0; i < 256; i++)
...
80105ac7:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
80105ace:	00 00 ef 
  initlock(&tickslock, "time");
80105ad1:	68 45 7b 10 80       	push   $0x80107b45
80105ad6:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105adb:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105ae1:	c1 e8 10             	shr    $0x10,%eax
80105ae4:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
80105aea:	e8 81 ea ff ff       	call   80104570 <initlock>
}
...
80105b0b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b0f:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105b54:	ff 24 85 ec 7b 10 80 	jmp    *-0x7fef8414(,%eax,4)
...
80105c35:	68 a8 7b 10 80       	push   $0x80107ba8
...
80105c87:	68 50 7b 10 80       	push   $0x80107b50
...
80105cc5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105cc8:	e8 33 ef ff ff       	call   80104c00 <syscall>
    if(myproc()->killed)
...
80105d40:	68 80 3d 11 80       	push   $0x80113d80
80105d45:	e8 f6 e9 ff ff       	call   80104740 <acquire>
      wakeup(&ticks);
80105d4a:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105d51:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105d58:	e8 a3 e3 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105d5d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105d64:	e8 77 e9 ff ff       	call   801046e0 <release>
...
80105da3:	68 74 7b 10 80       	push   $0x80107b74
80105da8:	e8 f3 a8 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105dad:	83 c4 14             	add    $0x14,%esp
80105db0:	68 4a 7b 10 80       	push   $0x80107b4a
...
80105e47:	74 78                	je     80105ec1 <uartinit+0xd1>
  uart = 1;
80105e49:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105e50:	00 00 00 
...
80105e5c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e5f:	bf 6c 7c 10 80       	mov    $0x80107c6c,%edi
...
80105f47:	6a 00                	push   $0x0
  jmp alltraps
80105f49:	e9 01 fb ff ff       	jmp    80105a4f <alltraps>
...
80105f50:	6a 01                	push   $0x1
  jmp alltraps
80105f52:	e9 f8 fa ff ff       	jmp    80105a4f <alltraps>
...
80105f59:	6a 02                	push   $0x2
  jmp alltraps
80105f5b:	e9 ef fa ff ff       	jmp    80105a4f <alltraps>
...
80105f62:	6a 03                	push   $0x3
  jmp alltraps
80105f64:	e9 e6 fa ff ff       	jmp    80105a4f <alltraps>
...
80105f6b:	6a 04                	push   $0x4
  jmp alltraps
80105f6d:	e9 dd fa ff ff       	jmp    80105a4f <alltraps>
...
80105f74:	6a 05                	push   $0x5
  jmp alltraps
80105f76:	e9 d4 fa ff ff       	jmp    80105a4f <alltraps>
...
80105f7d:	6a 06                	push   $0x6
  jmp alltraps
80105f7f:	e9 cb fa ff ff       	jmp    80105a4f <alltraps>
...
80105f86:	6a 07                	push   $0x7
  jmp alltraps
80105f88:	e9 c2 fa ff ff       	jmp    80105a4f <alltraps>
...
80105f8d:	6a 08                	push   $0x8
  jmp alltraps
80105f8f:	e9 bb fa ff ff       	jmp    80105a4f <alltraps>
...
80105f96:	6a 09                	push   $0x9
  jmp alltraps
80105f98:	e9 b2 fa ff ff       	jmp    80105a4f <alltraps>
...
80105f9d:	6a 0a                	push   $0xa
  jmp alltraps
80105f9f:	e9 ab fa ff ff       	jmp    80105a4f <alltraps>
...
80105fa4:	6a 0b                	push   $0xb
  jmp alltraps
80105fa6:	e9 a4 fa ff ff       	jmp    80105a4f <alltraps>
...
80105fab:	6a 0c                	push   $0xc
  jmp alltraps
80105fad:	e9 9d fa ff ff       	jmp    80105a4f <alltraps>
...
80105fb2:	6a 0d                	push   $0xd
  jmp alltraps
80105fb4:	e9 96 fa ff ff       	jmp    80105a4f <alltraps>
...
80105fb9:	6a 0e                	push   $0xe
  jmp alltraps
80105fbb:	e9 8f fa ff ff       	jmp    80105a4f <alltraps>
...
80105fc2:	6a 0f                	push   $0xf
  jmp alltraps
80105fc4:	e9 86 fa ff ff       	jmp    80105a4f <alltraps>
...
80105fcb:	6a 10                	push   $0x10
  jmp alltraps
80105fcd:	e9 7d fa ff ff       	jmp    80105a4f <alltraps>
...
80105fd2:	6a 11                	push   $0x11
  jmp alltraps
80105fd4:	e9 76 fa ff ff       	jmp    80105a4f <alltraps>
...
80105fdb:	6a 12                	push   $0x12
  jmp alltraps
80105fdd:	e9 6d fa ff ff       	jmp    80105a4f <alltraps>
...
80105fe4:	6a 13                	push   $0x13
  jmp alltraps
80105fe6:	e9 64 fa ff ff       	jmp    80105a4f <alltraps>
...
80105fed:	6a 14                	push   $0x14
  jmp alltraps
80105fef:	e9 5b fa ff ff       	jmp    80105a4f <alltraps>
...
80105ff6:	6a 15                	push   $0x15
  jmp alltraps
80105ff8:	e9 52 fa ff ff       	jmp    80105a4f <alltraps>
...
80105fff:	6a 16                	push   $0x16
  jmp alltraps
80106001:	e9 49 fa ff ff       	jmp    80105a4f <alltraps>
...
80106008:	6a 17                	push   $0x17
  jmp alltraps
8010600a:	e9 40 fa ff ff       	jmp    80105a4f <alltraps>
...
80106011:	6a 18                	push   $0x18
  jmp alltraps
80106013:	e9 37 fa ff ff       	jmp    80105a4f <alltraps>
...
8010601a:	6a 19                	push   $0x19
  jmp alltraps
8010601c:	e9 2e fa ff ff       	jmp    80105a4f <alltraps>
...
80106023:	6a 1a                	push   $0x1a
  jmp alltraps
80106025:	e9 25 fa ff ff       	jmp    80105a4f <alltraps>
...
8010602c:	6a 1b                	push   $0x1b
  jmp alltraps
8010602e:	e9 1c fa ff ff       	jmp    80105a4f <alltraps>
...
80106035:	6a 1c                	push   $0x1c
  jmp alltraps
80106037:	e9 13 fa ff ff       	jmp    80105a4f <alltraps>
...
8010603e:	6a 1d                	push   $0x1d
  jmp alltraps
80106040:	e9 0a fa ff ff       	jmp    80105a4f <alltraps>
...
80106047:	6a 1e                	push   $0x1e
  jmp alltraps
80106049:	e9 01 fa ff ff       	jmp    80105a4f <alltraps>
...
80106050:	6a 1f                	push   $0x1f
  jmp alltraps
80106052:	e9 f8 f9 ff ff       	jmp    80105a4f <alltraps>
...
80106059:	6a 20                	push   $0x20
  jmp alltraps
8010605b:	e9 ef f9 ff ff       	jmp    80105a4f <alltraps>
...
80106062:	6a 21                	push   $0x21
  jmp alltraps
80106064:	e9 e6 f9 ff ff       	jmp    80105a4f <alltraps>
...
8010606b:	6a 22                	push   $0x22
  jmp alltraps
8010606d:	e9 dd f9 ff ff       	jmp    80105a4f <alltraps>
...
80106074:	6a 23                	push   $0x23
  jmp alltraps
80106076:	e9 d4 f9 ff ff       	jmp    80105a4f <alltraps>
...
8010607d:	6a 24                	push   $0x24
  jmp alltraps
8010607f:	e9 cb f9 ff ff       	jmp    80105a4f <alltraps>
...
80106086:	6a 25                	push   $0x25
  jmp alltraps
80106088:	e9 c2 f9 ff ff       	jmp    80105a4f <alltraps>
...
8010608f:	6a 26                	push   $0x26
  jmp alltraps
80106091:	e9 b9 f9 ff ff       	jmp    80105a4f <alltraps>
...
80106098:	6a 27                	push   $0x27
  jmp alltraps
8010609a:	e9 b0 f9 ff ff       	jmp    80105a4f <alltraps>
...
801060a1:	6a 28                	push   $0x28
  jmp alltraps
801060a3:	e9 a7 f9 ff ff       	jmp    80105a4f <alltraps>
...
801060aa:	6a 29                	push   $0x29
  jmp alltraps
801060ac:	e9 9e f9 ff ff       	jmp    80105a4f <alltraps>
...
801060b3:	6a 2a                	push   $0x2a
  jmp alltraps
801060b5:	e9 95 f9 ff ff       	jmp    80105a4f <alltraps>
...
801060bc:	6a 2b                	push   $0x2b
  jmp alltraps
801060be:	e9 8c f9 ff ff       	jmp    80105a4f <alltraps>
...
801060c5:	6a 2c                	push   $0x2c
  jmp alltraps
801060c7:	e9 83 f9 ff ff       	jmp    80105a4f <alltraps>
...
801060ce:	6a 2d                	push   $0x2d
  jmp alltraps
801060d0:	e9 7a f9 ff ff       	jmp    80105a4f <alltraps>
...
801060d7:	6a 2e                	push   $0x2e
  jmp alltraps
801060d9:	e9 71 f9 ff ff       	jmp    80105a4f <alltraps>
...
801060e0:	6a 2f                	push   $0x2f
  jmp alltraps
801060e2:	e9 68 f9 ff ff       	jmp    80105a4f <alltraps>
...
801060e9:	6a 30                	push   $0x30
  jmp alltraps
801060eb:	e9 5f f9 ff ff       	jmp    80105a4f <alltraps>
...
801060f2:	6a 31                	push   $0x31
  jmp alltraps
801060f4:	e9 56 f9 ff ff       	jmp    80105a4f <alltraps>
...
801060fb:	6a 32                	push   $0x32
  jmp alltraps
801060fd:	e9 4d f9 ff ff       	jmp    80105a4f <alltraps>
...
80106104:	6a 33                	push   $0x33
  jmp alltraps
80106106:	e9 44 f9 ff ff       	jmp    80105a4f <alltraps>
...
8010610d:	6a 34                	push   $0x34
  jmp alltraps
8010610f:	e9 3b f9 ff ff       	jmp    80105a4f <alltraps>
...
80106116:	6a 35                	push   $0x35
  jmp alltraps
80106118:	e9 32 f9 ff ff       	jmp    80105a4f <alltraps>
...
8010611f:	6a 36                	push   $0x36
  jmp alltraps
80106121:	e9 29 f9 ff ff       	jmp    80105a4f <alltraps>
...
80106128:	6a 37                	push   $0x37
  jmp alltraps
8010612a:	e9 20 f9 ff ff       	jmp    80105a4f <alltraps>
...
80106131:	6a 38                	push   $0x38
  jmp alltraps
80106133:	e9 17 f9 ff ff       	jmp    80105a4f <alltraps>
...
8010613a:	6a 39                	push   $0x39
  jmp alltraps
8010613c:	e9 0e f9 ff ff       	jmp    80105a4f <alltraps>
...
80106143:	6a 3a                	push   $0x3a
  jmp alltraps
80106145:	e9 05 f9 ff ff       	jmp    80105a4f <alltraps>
...
8010614c:	6a 3b                	push   $0x3b
  jmp alltraps
8010614e:	e9 fc f8 ff ff       	jmp    80105a4f <alltraps>
...
80106155:	6a 3c                	push   $0x3c
  jmp alltraps
80106157:	e9 f3 f8 ff ff       	jmp    80105a4f <alltraps>
...
8010615e:	6a 3d                	push   $0x3d
  jmp alltraps
80106160:	e9 ea f8 ff ff       	jmp    80105a4f <alltraps>
...
80106167:	6a 3e                	push   $0x3e
  jmp alltraps
80106169:	e9 e1 f8 ff ff       	jmp    80105a4f <alltraps>
...
80106170:	6a 3f                	push   $0x3f
  jmp alltraps
80106172:	e9 d8 f8 ff ff       	jmp    80105a4f <alltraps>
...
80106179:	6a 40                	push   $0x40
  jmp alltraps
8010617b:	e9 cf f8 ff ff       	jmp    80105a4f <alltraps>
...
80106182:	6a 41                	push   $0x41
  jmp alltraps
80106184:	e9 c6 f8 ff ff       	jmp    80105a4f <alltraps>
...
8010618b:	6a 42                	push   $0x42
  jmp alltraps
8010618d:	e9 bd f8 ff ff       	jmp    80105a4f <alltraps>
...
80106194:	6a 43                	push   $0x43
  jmp alltraps
80106196:	e9 b4 f8 ff ff       	jmp    80105a4f <alltraps>
...
8010619d:	6a 44                	push   $0x44
  jmp alltraps
8010619f:	e9 ab f8 ff ff       	jmp    80105a4f <alltraps>
...
801061a6:	6a 45                	push   $0x45
  jmp alltraps
801061a8:	e9 a2 f8 ff ff       	jmp    80105a4f <alltraps>
...
801061af:	6a 46                	push   $0x46
  jmp alltraps
801061b1:	e9 99 f8 ff ff       	jmp    80105a4f <alltraps>
...
801061b8:	6a 47                	push   $0x47
  jmp alltraps
801061ba:	e9 90 f8 ff ff       	jmp    80105a4f <alltraps>
...
801061c1:	6a 48                	push   $0x48
  jmp alltraps
801061c3:	e9 87 f8 ff ff       	jmp    80105a4f <alltraps>
...
801061ca:	6a 49                	push   $0x49
  jmp alltraps
801061cc:	e9 7e f8 ff ff       	jmp    80105a4f <alltraps>
...
801061d3:	6a 4a                	push   $0x4a
  jmp alltraps
801061d5:	e9 75 f8 ff ff       	jmp    80105a4f <alltraps>
...
801061dc:	6a 4b                	push   $0x4b
  jmp alltraps
801061de:	e9 6c f8 ff ff       	jmp    80105a4f <alltraps>
...
801061e5:	6a 4c                	push   $0x4c
  jmp alltraps
801061e7:	e9 63 f8 ff ff       	jmp    80105a4f <alltraps>
...
801061ee:	6a 4d                	push   $0x4d
  jmp alltraps
801061f0:	e9 5a f8 ff ff       	jmp    80105a4f <alltraps>
...
801061f7:	6a 4e                	push   $0x4e
  jmp alltraps
801061f9:	e9 51 f8 ff ff       	jmp    80105a4f <alltraps>
...
80106200:	6a 4f                	push   $0x4f
  jmp alltraps
80106202:	e9 48 f8 ff ff       	jmp    80105a4f <alltraps>
...
80106209:	6a 50                	push   $0x50
  jmp alltraps
8010620b:	e9 3f f8 ff ff       	jmp    80105a4f <alltraps>
...
80106212:	6a 51                	push   $0x51
  jmp alltraps
80106214:	e9 36 f8 ff ff       	jmp    80105a4f <alltraps>
...
8010621b:	6a 52                	push   $0x52
  jmp alltraps
8010621d:	e9 2d f8 ff ff       	jmp    80105a4f <alltraps>
...
80106224:	6a 53                	push   $0x53
  jmp alltraps
80106226:	e9 24 f8 ff ff       	jmp    80105a4f <alltraps>
...
8010622d:	6a 54                	push   $0x54
  jmp alltraps
8010622f:	e9 1b f8 ff ff       	jmp    80105a4f <alltraps>
...
80106236:	6a 55                	push   $0x55
  jmp alltraps
80106238:	e9 12 f8 ff ff       	jmp    80105a4f <alltraps>
...
8010623f:	6a 56                	push   $0x56
  jmp alltraps
80106241:	e9 09 f8 ff ff       	jmp    80105a4f <alltraps>
...
80106248:	6a 57                	push   $0x57
  jmp alltraps
8010624a:	e9 00 f8 ff ff       	jmp    80105a4f <alltraps>
...
80106251:	6a 58                	push   $0x58
  jmp alltraps
80106253:	e9 f7 f7 ff ff       	jmp    80105a4f <alltraps>
...
8010625a:	6a 59                	push   $0x59
  jmp alltraps
8010625c:	e9 ee f7 ff ff       	jmp    80105a4f <alltraps>
...
80106263:	6a 5a                	push   $0x5a
  jmp alltraps
80106265:	e9 e5 f7 ff ff       	jmp    80105a4f <alltraps>
...
8010626c:	6a 5b                	push   $0x5b
  jmp alltraps
8010626e:	e9 dc f7 ff ff       	jmp    80105a4f <alltraps>
...
80106275:	6a 5c                	push   $0x5c
  jmp alltraps
80106277:	e9 d3 f7 ff ff       	jmp    80105a4f <alltraps>
...
8010627e:	6a 5d                	push   $0x5d
  jmp alltraps
80106280:	e9 ca f7 ff ff       	jmp    80105a4f <alltraps>
...
80106287:	6a 5e                	push   $0x5e
  jmp alltraps
80106289:	e9 c1 f7 ff ff       	jmp    80105a4f <alltraps>
...
80106290:	6a 5f                	push   $0x5f
  jmp alltraps
80106292:	e9 b8 f7 ff ff       	jmp    80105a4f <alltraps>
...
80106299:	6a 60                	push   $0x60
  jmp alltraps
8010629b:	e9 af f7 ff ff       	jmp    80105a4f <alltraps>
...
801062a2:	6a 61                	push   $0x61
  jmp alltraps
801062a4:	e9 a6 f7 ff ff       	jmp    80105a4f <alltraps>
...
801062ab:	6a 62                	push   $0x62
  jmp alltraps
801062ad:	e9 9d f7 ff ff       	jmp    80105a4f <alltraps>
...
801062b4:	6a 63                	push   $0x63
  jmp alltraps
801062b6:	e9 94 f7 ff ff       	jmp    80105a4f <alltraps>
...
801062bd:	6a 64                	push   $0x64
  jmp alltraps
801062bf:	e9 8b f7 ff ff       	jmp    80105a4f <alltraps>
...
801062c6:	6a 65                	push   $0x65
  jmp alltraps
801062c8:	e9 82 f7 ff ff       	jmp    80105a4f <alltraps>
...
801062cf:	6a 66                	push   $0x66
  jmp alltraps
801062d1:	e9 79 f7 ff ff       	jmp    80105a4f <alltraps>
...
801062d8:	6a 67                	push   $0x67
  jmp alltraps
801062da:	e9 70 f7 ff ff       	jmp    80105a4f <alltraps>
...
801062e1:	6a 68                	push   $0x68
  jmp alltraps
801062e3:	e9 67 f7 ff ff       	jmp    80105a4f <alltraps>
...
801062ea:	6a 69                	push   $0x69
  jmp alltraps
801062ec:	e9 5e f7 ff ff       	jmp    80105a4f <alltraps>
...
801062f3:	6a 6a                	push   $0x6a
  jmp alltraps
801062f5:	e9 55 f7 ff ff       	jmp    80105a4f <alltraps>
...
801062fc:	6a 6b                	push   $0x6b
  jmp alltraps
801062fe:	e9 4c f7 ff ff       	jmp    80105a4f <alltraps>
...
80106305:	6a 6c                	push   $0x6c
  jmp alltraps
80106307:	e9 43 f7 ff ff       	jmp    80105a4f <alltraps>
...
8010630e:	6a 6d                	push   $0x6d
  jmp alltraps
80106310:	e9 3a f7 ff ff       	jmp    80105a4f <alltraps>
...
80106317:	6a 6e                	push   $0x6e
  jmp alltraps
80106319:	e9 31 f7 ff ff       	jmp    80105a4f <alltraps>
...
80106320:	6a 6f                	push   $0x6f
  jmp alltraps
80106322:	e9 28 f7 ff ff       	jmp    80105a4f <alltraps>
...
80106329:	6a 70                	push   $0x70
  jmp alltraps
8010632b:	e9 1f f7 ff ff       	jmp    80105a4f <alltraps>
...
80106332:	6a 71                	push   $0x71
  jmp alltraps
80106334:	e9 16 f7 ff ff       	jmp    80105a4f <alltraps>
...
8010633b:	6a 72                	push   $0x72
  jmp alltraps
8010633d:	e9 0d f7 ff ff       	jmp    80105a4f <alltraps>
...
80106344:	6a 73                	push   $0x73
  jmp alltraps
80106346:	e9 04 f7 ff ff       	jmp    80105a4f <alltraps>
...
8010634d:	6a 74                	push   $0x74
  jmp alltraps
8010634f:	e9 fb f6 ff ff       	jmp    80105a4f <alltraps>
...
80106356:	6a 75                	push   $0x75
  jmp alltraps
80106358:	e9 f2 f6 ff ff       	jmp    80105a4f <alltraps>
...
8010635f:	6a 76                	push   $0x76
  jmp alltraps
80106361:	e9 e9 f6 ff ff       	jmp    80105a4f <alltraps>
...
80106368:	6a 77                	push   $0x77
  jmp alltraps
8010636a:	e9 e0 f6 ff ff       	jmp    80105a4f <alltraps>
...
80106371:	6a 78                	push   $0x78
  jmp alltraps
80106373:	e9 d7 f6 ff ff       	jmp    80105a4f <alltraps>
...
8010637a:	6a 79                	push   $0x79
  jmp alltraps
8010637c:	e9 ce f6 ff ff       	jmp    80105a4f <alltraps>
...
80106383:	6a 7a                	push   $0x7a
  jmp alltraps
80106385:	e9 c5 f6 ff ff       	jmp    80105a4f <alltraps>
...
8010638c:	6a 7b                	push   $0x7b
  jmp alltraps
8010638e:	e9 bc f6 ff ff       	jmp    80105a4f <alltraps>
...
80106395:	6a 7c                	push   $0x7c
  jmp alltraps
80106397:	e9 b3 f6 ff ff       	jmp    80105a4f <alltraps>
...
8010639e:	6a 7d                	push   $0x7d
  jmp alltraps
801063a0:	e9 aa f6 ff ff       	jmp    80105a4f <alltraps>
...
801063a7:	6a 7e                	push   $0x7e
  jmp alltraps
801063a9:	e9 a1 f6 ff ff       	jmp    80105a4f <alltraps>
...
801063b0:	6a 7f                	push   $0x7f
  jmp alltraps
801063b2:	e9 98 f6 ff ff       	jmp    80105a4f <alltraps>
...
801063b9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801063be:	e9 8c f6 ff ff       	jmp    80105a4f <alltraps>
...
801063c5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063ca:	e9 80 f6 ff ff       	jmp    80105a4f <alltraps>
...
801063d1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063d6:	e9 74 f6 ff ff       	jmp    80105a4f <alltraps>
...
801063dd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063e2:	e9 68 f6 ff ff       	jmp    80105a4f <alltraps>
...
801063e9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063ee:	e9 5c f6 ff ff       	jmp    80105a4f <alltraps>
...
801063f5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063fa:	e9 50 f6 ff ff       	jmp    80105a4f <alltraps>
...
80106401:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106406:	e9 44 f6 ff ff       	jmp    80105a4f <alltraps>
...
8010640d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106412:	e9 38 f6 ff ff       	jmp    80105a4f <alltraps>
...
80106419:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010641e:	e9 2c f6 ff ff       	jmp    80105a4f <alltraps>
...
80106425:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010642a:	e9 20 f6 ff ff       	jmp    80105a4f <alltraps>
...
80106431:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106436:	e9 14 f6 ff ff       	jmp    80105a4f <alltraps>
...
8010643d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106442:	e9 08 f6 ff ff       	jmp    80105a4f <alltraps>
...
80106449:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010644e:	e9 fc f5 ff ff       	jmp    80105a4f <alltraps>
...
80106455:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010645a:	e9 f0 f5 ff ff       	jmp    80105a4f <alltraps>
...
80106461:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106466:	e9 e4 f5 ff ff       	jmp    80105a4f <alltraps>
...
8010646d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106472:	e9 d8 f5 ff ff       	jmp    80105a4f <alltraps>
...
80106479:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010647e:	e9 cc f5 ff ff       	jmp    80105a4f <alltraps>
...
80106485:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010648a:	e9 c0 f5 ff ff       	jmp    80105a4f <alltraps>
...
80106491:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106496:	e9 b4 f5 ff ff       	jmp    80105a4f <alltraps>
...
8010649d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801064a2:	e9 a8 f5 ff ff       	jmp    80105a4f <alltraps>
...
801064a9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801064ae:	e9 9c f5 ff ff       	jmp    80105a4f <alltraps>
...
801064b5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801064ba:	e9 90 f5 ff ff       	jmp    80105a4f <alltraps>
...
801064c1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064c6:	e9 84 f5 ff ff       	jmp    80105a4f <alltraps>
...
801064cd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064d2:	e9 78 f5 ff ff       	jmp    80105a4f <alltraps>
...
801064d9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064de:	e9 6c f5 ff ff       	jmp    80105a4f <alltraps>
...
801064e5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064ea:	e9 60 f5 ff ff       	jmp    80105a4f <alltraps>
...
801064f1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064f6:	e9 54 f5 ff ff       	jmp    80105a4f <alltraps>
...
801064fd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106502:	e9 48 f5 ff ff       	jmp    80105a4f <alltraps>
...
80106509:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010650e:	e9 3c f5 ff ff       	jmp    80105a4f <alltraps>
...
80106515:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010651a:	e9 30 f5 ff ff       	jmp    80105a4f <alltraps>
...
80106521:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106526:	e9 24 f5 ff ff       	jmp    80105a4f <alltraps>
...
8010652d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106532:	e9 18 f5 ff ff       	jmp    80105a4f <alltraps>
...
80106539:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010653e:	e9 0c f5 ff ff       	jmp    80105a4f <alltraps>
...
80106545:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010654a:	e9 00 f5 ff ff       	jmp    80105a4f <alltraps>
...
80106551:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106556:	e9 f4 f4 ff ff       	jmp    80105a4f <alltraps>
...
8010655d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106562:	e9 e8 f4 ff ff       	jmp    80105a4f <alltraps>
...
80106569:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010656e:	e9 dc f4 ff ff       	jmp    80105a4f <alltraps>
...
80106575:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010657a:	e9 d0 f4 ff ff       	jmp    80105a4f <alltraps>
...
80106581:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106586:	e9 c4 f4 ff ff       	jmp    80105a4f <alltraps>
...
8010658d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106592:	e9 b8 f4 ff ff       	jmp    80105a4f <alltraps>
...
80106599:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010659e:	e9 ac f4 ff ff       	jmp    80105a4f <alltraps>
...
801065a5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801065aa:	e9 a0 f4 ff ff       	jmp    80105a4f <alltraps>
...
801065b1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801065b6:	e9 94 f4 ff ff       	jmp    80105a4f <alltraps>
...
801065bd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065c2:	e9 88 f4 ff ff       	jmp    80105a4f <alltraps>
...
801065c9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065ce:	e9 7c f4 ff ff       	jmp    80105a4f <alltraps>
...
801065d5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065da:	e9 70 f4 ff ff       	jmp    80105a4f <alltraps>
...
801065e1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065e6:	e9 64 f4 ff ff       	jmp    80105a4f <alltraps>
...
801065ed:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065f2:	e9 58 f4 ff ff       	jmp    80105a4f <alltraps>
...
801065f9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065fe:	e9 4c f4 ff ff       	jmp    80105a4f <alltraps>
...
80106605:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010660a:	e9 40 f4 ff ff       	jmp    80105a4f <alltraps>
...
80106611:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106616:	e9 34 f4 ff ff       	jmp    80105a4f <alltraps>
...
8010661d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106622:	e9 28 f4 ff ff       	jmp    80105a4f <alltraps>
...
80106629:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010662e:	e9 1c f4 ff ff       	jmp    80105a4f <alltraps>
...
80106635:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010663a:	e9 10 f4 ff ff       	jmp    80105a4f <alltraps>
...
80106641:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106646:	e9 04 f4 ff ff       	jmp    80105a4f <alltraps>
...
8010664d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106652:	e9 f8 f3 ff ff       	jmp    80105a4f <alltraps>
...
80106659:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010665e:	e9 ec f3 ff ff       	jmp    80105a4f <alltraps>
...
80106665:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010666a:	e9 e0 f3 ff ff       	jmp    80105a4f <alltraps>
...
80106671:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106676:	e9 d4 f3 ff ff       	jmp    80105a4f <alltraps>
...
8010667d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106682:	e9 c8 f3 ff ff       	jmp    80105a4f <alltraps>
...
80106689:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010668e:	e9 bc f3 ff ff       	jmp    80105a4f <alltraps>
...
80106695:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010669a:	e9 b0 f3 ff ff       	jmp    80105a4f <alltraps>
...
801066a1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801066a6:	e9 a4 f3 ff ff       	jmp    80105a4f <alltraps>
...
801066ad:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801066b2:	e9 98 f3 ff ff       	jmp    80105a4f <alltraps>
...
801066b9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801066be:	e9 8c f3 ff ff       	jmp    80105a4f <alltraps>
...
801066c5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066ca:	e9 80 f3 ff ff       	jmp    80105a4f <alltraps>
...
801066d1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066d6:	e9 74 f3 ff ff       	jmp    80105a4f <alltraps>
...
801066dd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066e2:	e9 68 f3 ff ff       	jmp    80105a4f <alltraps>
...
801066e9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066ee:	e9 5c f3 ff ff       	jmp    80105a4f <alltraps>
...
801066f5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066fa:	e9 50 f3 ff ff       	jmp    80105a4f <alltraps>
...
80106701:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106706:	e9 44 f3 ff ff       	jmp    80105a4f <alltraps>
...
8010670d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106712:	e9 38 f3 ff ff       	jmp    80105a4f <alltraps>
...
80106719:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010671e:	e9 2c f3 ff ff       	jmp    80105a4f <alltraps>
...
80106725:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010672a:	e9 20 f3 ff ff       	jmp    80105a4f <alltraps>
...
80106731:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106736:	e9 14 f3 ff ff       	jmp    80105a4f <alltraps>
...
8010673d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106742:	e9 08 f3 ff ff       	jmp    80105a4f <alltraps>
...
80106749:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010674e:	e9 fc f2 ff ff       	jmp    80105a4f <alltraps>
...
80106755:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010675a:	e9 f0 f2 ff ff       	jmp    80105a4f <alltraps>
...
80106761:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106766:	e9 e4 f2 ff ff       	jmp    80105a4f <alltraps>
...
8010676d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106772:	e9 d8 f2 ff ff       	jmp    80105a4f <alltraps>
...
80106779:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010677e:	e9 cc f2 ff ff       	jmp    80105a4f <alltraps>
...
80106785:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010678a:	e9 c0 f2 ff ff       	jmp    80105a4f <alltraps>
...
80106791:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106796:	e9 b4 f2 ff ff       	jmp    80105a4f <alltraps>
...
8010679d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801067a2:	e9 a8 f2 ff ff       	jmp    80105a4f <alltraps>
...
801067a9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801067ae:	e9 9c f2 ff ff       	jmp    80105a4f <alltraps>
...
801067b5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801067ba:	e9 90 f2 ff ff       	jmp    80105a4f <alltraps>
...
801067c1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067c6:	e9 84 f2 ff ff       	jmp    80105a4f <alltraps>
...
801067cd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067d2:	e9 78 f2 ff ff       	jmp    80105a4f <alltraps>
...
801067d9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067de:	e9 6c f2 ff ff       	jmp    80105a4f <alltraps>
...
801067e5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067ea:	e9 60 f2 ff ff       	jmp    80105a4f <alltraps>
...
801067f1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067f6:	e9 54 f2 ff ff       	jmp    80105a4f <alltraps>
...
801067fd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106802:	e9 48 f2 ff ff       	jmp    80105a4f <alltraps>
...
80106809:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010680e:	e9 3c f2 ff ff       	jmp    80105a4f <alltraps>
...
80106815:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010681a:	e9 30 f2 ff ff       	jmp    80105a4f <alltraps>
...
80106821:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106826:	e9 24 f2 ff ff       	jmp    80105a4f <alltraps>
...
8010682d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106832:	e9 18 f2 ff ff       	jmp    80105a4f <alltraps>
...
80106839:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010683e:	e9 0c f2 ff ff       	jmp    80105a4f <alltraps>
...
80106845:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010684a:	e9 00 f2 ff ff       	jmp    80105a4f <alltraps>
...
80106851:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106856:	e9 f4 f1 ff ff       	jmp    80105a4f <alltraps>
...
8010685d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106862:	e9 e8 f1 ff ff       	jmp    80105a4f <alltraps>
...
80106869:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010686e:	e9 dc f1 ff ff       	jmp    80105a4f <alltraps>
...
80106875:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010687a:	e9 d0 f1 ff ff       	jmp    80105a4f <alltraps>
...
80106881:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106886:	e9 c4 f1 ff ff       	jmp    80105a4f <alltraps>
...
8010688d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106892:	e9 b8 f1 ff ff       	jmp    80105a4f <alltraps>
...
80106899:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010689e:	e9 ac f1 ff ff       	jmp    80105a4f <alltraps>
...
801068a5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801068aa:	e9 a0 f1 ff ff       	jmp    80105a4f <alltraps>
...
801068b1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801068b6:	e9 94 f1 ff ff       	jmp    80105a4f <alltraps>
...
801068bd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068c2:	e9 88 f1 ff ff       	jmp    80105a4f <alltraps>
...
801068c9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068ce:	e9 7c f1 ff ff       	jmp    80105a4f <alltraps>
...
801068d5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068da:	e9 70 f1 ff ff       	jmp    80105a4f <alltraps>
...
801068e1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068e6:	e9 64 f1 ff ff       	jmp    80105a4f <alltraps>
...
801068ed:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068f2:	e9 58 f1 ff ff       	jmp    80105a4f <alltraps>
...
801068f9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068fe:	e9 4c f1 ff ff       	jmp    80105a4f <alltraps>
...
80106905:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010690a:	e9 40 f1 ff ff       	jmp    80105a4f <alltraps>
...
80106911:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106916:	e9 34 f1 ff ff       	jmp    80105a4f <alltraps>
...
8010691d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106922:	e9 28 f1 ff ff       	jmp    80105a4f <alltraps>
...
80106929:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010692e:	e9 1c f1 ff ff       	jmp    80105a4f <alltraps>
...
80106935:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010693a:	e9 10 f1 ff ff       	jmp    80105a4f <alltraps>
...
80106941:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106946:	e9 04 f1 ff ff       	jmp    80105a4f <alltraps>
...
8010694d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106952:	e9 f8 f0 ff ff       	jmp    80105a4f <alltraps>
...
80106959:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010695e:	e9 ec f0 ff ff       	jmp    80105a4f <alltraps>
...
80106965:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010696a:	e9 e0 f0 ff ff       	jmp    80105a4f <alltraps>
...
80106971:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106976:	e9 d4 f0 ff ff       	jmp    80105a4f <alltraps>
...
8010697d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106982:	e9 c8 f0 ff ff       	jmp    80105a4f <alltraps>
...
80106989:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010698e:	e9 bc f0 ff ff       	jmp    80105a4f <alltraps>
...
80106995:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010699a:	e9 b0 f0 ff ff       	jmp    80105a4f <alltraps>
...
801069a1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801069a6:	e9 a4 f0 ff ff       	jmp    80105a4f <alltraps>
...
801069ad:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801069b2:	e9 98 f0 ff ff       	jmp    80105a4f <alltraps>
...
80106b05:	e8 f6 dc ff ff       	call   80104800 <memset>
...
80106b4d:	68 74 7c 10 80       	push   $0x80107c74
...
80106bf0:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106c24:	0f 84 c2 00 00 00    	je     80106cec <switchuvm+0xec>
  pushcli();
80106c2a:	e8 c1 d9 ff ff       	call   801045f0 <pushcli>
...
80106d3f:	e8 bc da ff ff       	call   80104800 <memset>
...
80106d72:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d73:	e9 28 db ff ff       	jmp    801048a0 <memmove>
    panic("inituvm: more than a page");
80106d78:	83 ec 0c             	sub    $0xc,%esp
80106d7b:	68 b9 7c 10 80       	push   $0x80107cb9
...
80106de0:	68 d3 7c 10 80       	push   $0x80107cd3
...
80106e68:	68 74 7d 10 80       	push   $0x80107d74
...
80106ecb:	e8 30 d9 ff ff       	call   80104800 <memset>
...
80106f09:	68 f1 7c 10 80       	push   $0x80107cf1
...
80106f6b:	68 09 7d 10 80       	push   $0x80107d09
...
8010704c:	68 25 7d 10 80       	push   $0x80107d25
...
80107080:	e8 7b d7 ff ff       	call   80104800 <memset>
...
801070eb:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010711c:	68 36 7d 10 80       	push   $0x80107d36
...
80107192:	68 40 7d 10 80       	push   $0x80107d40
...
801071f0:	e8 ab d6 ff ff       	call   801048a0 <memmove>
...
80107267:	68 5a 7d 10 80       	push   $0x80107d5a
...
80107320:	e8 7b d5 ff ff       	call   801048a0 <memmove>
    len -= n;
    buf += n;
