...
int main(void) {
  ...
  18:	78 40                	js     5a <main+0x5a>
        printf(2, "fork failed\n");
        
        exit();
    } else if (pid == 0) {
  1a:	75 2f                	jne    4b <main+0x4b>
        // cerate another child process
        int pid2 = fork();
  1c:	e8 ba 02 00 00       	call   2db <fork>
        if (pid2 < 0) {
  21:	85 c0                	test   %eax,%eax
  23:	78 35                	js     5a <main+0x5a>
            printf(2, "fork failed\n");
            exit();

        } else if (pid2 == 0) {
  25:	74 46                	je     6d <main+0x6d>
            exit();
        }
  ...
  27:	e8 37 03 00 00       	call   363 <getpid>
  2c:	52                   	push   %edx
  2d:	50                   	push   %eax
  2e:	68 9e 07 00 00       	push   $0x79e
  33:	6a 01                	push   $0x1
  35:	e8 16 04 00 00       	call   450 <printf>
            sleep(10000); // xv6 sleep takes ticks as arguments, 1 second is TPS (ticks per second) ticks.
  3a:	c7 04 24 10 27 00 00 	movl   $0x2710,(%esp)
  41:	e8 2d 03 00 00       	call   373 <sleep>
            exit();
  ...
  63:	e8 e8 03 00 00       	call   450 <printf>
        exit();
  68:	e8 76 02 00 00       	call   2e3 <exit>
            sleep(20);
  6d:	83 ec 0c             	sub    $0xc,%esp
  70:	6a 14                	push   $0x14
  72:	e8 fc 02 00 00       	call   373 <sleep>
            printf(1, "Child process 2 pid: %d\n", getpid());
  77:	e8 e7 02 00 00       	call   363 <getpid>
  7c:	83 c4 0c             	add    $0xc,%esp
  7f:	50                   	push   %eax
  80:	68 85 07 00 00       	push   $0x785
  85:	eb ac                	jmp    33 <main+0x33>
  87:	66 90                	xchg   %ax,%ax
  89:	66 90                	xchg   %ax,%ax
  8b:	66 90                	xchg   %ax,%ax
  8d:	66 90                	xchg   %ax,%ax
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba b7 07 00 00       	mov    $0x7b7,%edx
        while(*s != 0){
