...
_open_file:     file format elf32-i386
...
int main(void) {
  ...
  pid = fork();
  14:	e8 42 03 00 00       	call   35b <fork>

  if (pid < 0) {
  19:	85 c0                	test   %eax,%eax
  1b:	78 5e                	js     7b <main+0x7b>
    printf(1, "Fork failed\n");
    exit();
  }

  if (pid == 0) {
  1d:	75 57                	jne    76 <main+0x76>
    // Child process
  ...
  1f:	56                   	push   %esi
  20:	56                   	push   %esi
  21:	68 01 02 00 00       	push   $0x201
  26:	68 f8 07 00 00       	push   $0x7f8
  ...
  39:	68 02 08 00 00       	push   $0x802
  3e:	e8 60 03 00 00       	call   3a3 <open>
    fd3 = open(FILE3, O_CREATE | O_WRONLY);
  43:	59                   	pop    %ecx
  44:	5b                   	pop    %ebx
  45:	68 01 02 00 00       	push   $0x201
  4a:	68 0c 08 00 00       	push   $0x80c
    fd2 = open(FILE2, O_CREATE | O_WRONLY);
  4f:	89 c6                	mov    %eax,%esi
    fd3 = open(FILE3, O_CREATE | O_WRONLY);
  51:	e8 4d 03 00 00       	call   3a3 <open>
  ...
  5d:	09 f0                	or     %esi,%eax
  5f:	09 d8                	or     %ebx,%eax
  61:	79 2b                	jns    8e <main+0x8e>
      printf(1, "Failed to open files\n");
  63:	53                   	push   %ebx
  64:	53                   	push   %ebx
  65:	68 23 08 00 00       	push   $0x823
  6a:	6a 01                	push   $0x1
  6c:	e8 5f 04 00 00       	call   4d0 <printf>
      exit();
  71:	e8 ed 02 00 00       	call   363 <exit>
    ...
    exit();
  76:	e8 e8 02 00 00       	call   363 <exit>
    printf(1, "Fork failed\n");
  7b:	56                   	push   %esi
  7c:	56                   	push   %esi
  7d:	68 16 08 00 00       	push   $0x816
  82:	6a 01                	push   $0x1
  84:	e8 47 04 00 00       	call   4d0 <printf>
    exit();
  89:	e8 d5 02 00 00       	call   363 <exit>
    printf(1, "Opened files successfully\n");
  8e:	50                   	push   %eax
  8f:	50                   	push   %eax
  90:	68 39 08 00 00       	push   $0x839
  95:	6a 01                	push   $0x1
  97:	e8 34 04 00 00       	call   4d0 <printf>
    sleep(10000);
  9c:	c7 04 24 10 27 00 00 	movl   $0x2710,(%esp)
  a3:	e8 4b 03 00 00       	call   3f3 <sleep>
    close(fd1);
  a8:	89 3c 24             	mov    %edi,(%esp)
  ab:	e8 db 02 00 00       	call   38b <close>
    close(fd2);
  b0:	89 34 24             	mov    %esi,(%esp)
  b3:	e8 d3 02 00 00       	call   38b <close>
    close(fd3);
  b8:	89 1c 24             	mov    %ebx,(%esp)
  bb:	e8 cb 02 00 00       	call   38b <close>
    delete_files();
  c0:	e8 1b 00 00 00       	call   e0 <delete_files>
    printf(1, "Closed and deleted files\n");
  c5:	5a                   	pop    %edx
  c6:	59                   	pop    %ecx
  c7:	68 54 08 00 00       	push   $0x854
  cc:	6a 01                	push   $0x1
...
000000e0 <delete_files>:
void delete_files() {
  e0:	55                   	push   %ebp
  e1:	89 e5                	mov    %esp,%ebp
  e3:	83 ec 14             	sub    $0x14,%esp
  unlink(FILE1);
  e6:	68 f8 07 00 00       	push   $0x7f8
  eb:	e8 c3 02 00 00       	call   3b3 <unlink>
  unlink(FILE2);
  f0:	c7 04 24 02 08 00 00 	movl   $0x802,(%esp)
  f7:	e8 b7 02 00 00       	call   3b3 <unlink>
  unlink(FILE3);
  fc:	c7 04 24 0c 08 00 00 	movl   $0x80c,(%esp)
 103:	e8 ab 02 00 00       	call   3b3 <unlink>
}
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 6e 08 00 00       	mov    $0x86e,%edx
        while(*s != 0){
